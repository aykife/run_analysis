...
Method of Operation
Initial Point
The R script first checks for the existence of the data file inside the working directory and if not found, it connect to the cloud and download the zipped data file, and unzip it.
